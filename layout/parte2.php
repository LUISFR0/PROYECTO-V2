  <!-- Control Sidebar (vacío, requerido por AdminLTE) -->
  <aside class="control-sidebar control-sidebar-dark"></aside>

  <!-- Footer -->
  <footer class="main-footer" style="
    background: var(--py-card, #1e293b);
    border-top: 1px solid var(--py-card-border, rgba(255,255,255,.07));
    color: var(--py-text-muted, #94a3b8);
    padding: 14px 24px;
    font-size: 13px;
    display: flex;
    align-items: center;
