  ...
  <div class="content">
    <div class="container-fluid">
      ...
      <div class="alert alert-info">
        <i class="fas fa-info-circle"></i> No hay piezas en bodega actualmente.
      </div>
      <?php else: ?>

      <!-- BOTONES EXPORTAR -->
      <div class="mb-3 d-flex gap-2">
        <a href="<?= $URL ?>/app/controllers/stock/export_bodega.php?tipo=excel"
           class="btn btn-success mr-2">
          <i class="fas fa-file-excel"></i> Exportar Excel
        </a>
        <a href="<?= $URL ?>/app/controllers/stock/export_bodega.php?tipo=pdf"
      ...
      <div class="card card-outline card-success">
        ...
        <div class="card-body p-0">
          <table id="tblBodega" class="table table-bordered table-striped table-sm mb-0">
            <thead class="thead-light">
              <tr>
                ...
                <th>Producto</th>
                <th>Categoría</th>
                <th class="text-center">Piezas en bodega</th>
            ...
            <tbody>
              ...
              <tr>
                ...
                <td class="text-center">
                  <span class="badge badge-success badge-lg" style="font-size:.95em;">
                    <?= $p['piezas'] ?>
                  </span>
                </td>
                <td>
